    ...
    rows.append(
        {
            ...
            "1차 정확성(1-5)": source_row["정확성(1-5)"],
            "1차 구체성(1-5)": source_row["구체성(1-5)"],
            "1차 실습 단계 적합성(1-5)": source_row["실습 단계 적합성(1-5)"],
            "1차 안전성(1-5)": source_row["안전성(1-5)"],
            "1차 이해 용이성(1-5)": source_row["이해 용이성(1-5)"],
            "1차 평균 점수": source_row["평균 점수"],
            "1차 최종 판정": source_row["최종 판정(O/△/X)"],
            "1차 평가 메모": source_row["평가 메모"],
