...
> **구분:** 이 문서는 2026-07-24 후보 feature cache 기반의 가중치 선택 단계 결과이다. 논문 Table III과 Table VI의 최종 end-to-end 수치는 `final_metric_provenance.md` 및 `SCIE용/data/15_*`, `31_*`, `32_*` 파일을 기준으로 한다. 아래 탐색 수치를 최종 논문 성능표와 직접 비교하거나 혼용하지 않는다.
