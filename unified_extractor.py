...
PDF_PATH = os.path.join(BASE_DIR, "A-Series.pdf")
OUTPUT_DIR = os.path.join(BASE_DIR, "final_refined_data")
REPORT_PATH = os.path.join(BASE_DIR, "final_processing_report.json")

MODEL_PATH = "./siglip_local"
